...
#	device/huawei/G300/init:root/init \

# VOLD files
PRODUCT_COPY_FILES += \
	device/huawei/G300/proprietary/etc/vold_internal.fstab:system/etc/vold_internal.fstab \
	device/huawei/G300/proprietary/etc/vold_external.fstab:system/etc/vold_external.fstab \
...
PRODUCT_COPY_FILES += \
	...
	device/huawei/G300/proprietary/usr/idc/synaptics.idc:system/usr/idc/synaptics.idc \
